    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
            .authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers("/people/home", "/people/meuscursos", "/people/todoscursos", "/courses/course/*", "/people/meusdados", "/people/editarPessoa/*", "/people/meuscartoes", "/people/cadastrarcartao").hasRole("PERSON")
